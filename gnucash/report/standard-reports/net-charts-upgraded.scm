...
(define-module (gnucash report standard-reports net-charts-upgraded))
  ...
  (let* ((to-date-t64 (gnc:time64-end-day-time
    ...
    (if
     ...
     (let* ((assets-list (process-datelist
       ...
       (gnc:html-chart-set-row-labels! chart date-iso-string-list)

       (when linechart?
         (gnc:html-chart-set-y-grid?! chart y-grid)
         (gnc:html-chart-set-x-grid?! chart y-grid))
       ...
       (if linechart?
           (begin
             (gnc:html-chart-set-line-width! chart line-width)
             (gnc:html-chart-set-markers! chart markers)))
...
(define net-worth-linechart-uuid "exp-d8b63264186b11e19038001558291366")
(define net-worth-barchart-uuid "exp-cbba1696c8c24744848062c7f1cf4a72")
(define income-expense-barchart-uuid "exp-80769921e87943adade887b9835a7685")

;; Here we define the actual report
(gnc:define-report
 'version 1
 'name (N_ "Experimental Net Worth Barchart")
...
(gnc:define-report
 'version 1
 'name (N_ "Experimental Income/Expense Chart")
...
(gnc:define-report
 'version 1
 'name (N_ "Experimental Net Worth Linechart")
...
(gnc:define-report
 'version 1
 'name (N_ "Experimental Income & Expense Linechart")
 'report-guid "exp-e533c998186b11e1b2e2001558291366"
