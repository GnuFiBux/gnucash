...
(define-module (gnucash report standard-reports price-scatter-upgraded))
...
(define (renderer report-obj)
  ...
  (let* ((to-date (gnc:time64-end-day-time 
    ...
    (gnc:html-chart-set-markers! chart 
                                  (case marker
                                    ((diamond) "diamond")
                                    ((circle) "circle")
                                    ((square) "square")
    ...
    ;; (gnc:html-chart-set-markercolor! chart mcolor)
...
(gnc:define-report
 'version 1
 'name (N_ "Price")
 'report-guid "exp-1d241609fd4644caad765c95be20ff4c"
 'menu-path (list gnc:menuname-utility)
 'menu-name (N_ "Experimental Price Scatterplot")
