...
(export gnc:make-html-chart-internal)
...
(export gnc:html-chart-x-axis-label)
(export gnc:html-chart-set-x-axis-label!)
(export gnc:html-chart-y-axis-label)
(export gnc:html-chart-set-y-axis-label!)
(export gnc:html-chart-row-labels)
(export gnc:html-chart-set-row-labels!)
(export gnc:html-chart-row-labels-rotated?)
(export gnc:html-chart-set-row-labels-rotated?!)
(export gnc:html-chart-stacked?)
(export gnc:html-chart-set-stacked?!)
(export gnc:html-chart-set-type!)
(export gnc:html-chart-markers)
(export gnc:html-chart-set-markers!)
(export gnc:html-chart-x-grid?)
(export gnc:html-chart-set-x-grid?!)
(export gnc:html-chart-y-grid?)
(export gnc:html-chart-set-y-grid?!)
(export gnc:html-chart-col-labels)
(export gnc:html-chart-set-col-labels!)
(export gnc:html-chart-colors)
(export gnc:html-chart-set-colors!)
(export gnc:html-chart-legend-reversed?)
(export gnc:html-chart-set-legend-reversed?!)
(export gnc:html-chart-title)
(export gnc:html-chart-set-title!)
(export gnc:html-chart-subtitle)
(export gnc:html-chart-set-subtitle!)
(export gnc:html-chart-urls)
(export gnc:html-chart-set-urls!)
(export gnc:html-chart-append-row!)
(export gnc:html-chart-prepend-row!)
(export gnc:html-chart-append-column!)
(export gnc:html-chart-prepend-column!)
(export gnc:html-chart-render chart)
(export gnc:html-chart-set-line-width!)
(export gnc:html-chart-set-currency-symbol!)
(export gnc:html-chart-line-width)
