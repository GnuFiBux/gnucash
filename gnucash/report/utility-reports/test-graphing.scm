...
(define (simple-pie-chart)
  (let ((chart (gnc:make-html-chart)))
    ...
    (gnc:html-chart-set-subtitle! chart "Pie Chart SubTitle")
    (gnc:html-chart-set-width! chart 320)
    (gnc:html-chart-set-height! chart 240)
    (gnc:html-chart-set-data! chart '(25 45 30))
    (gnc:html-chart-set-labels! chart '("foo" "bar" "baz"))
    (gnc:html-chart-set-colors! chart (gnc:assign-colors 3))
    chart
    )
  )
...
(define (simple-bar-chart stacked?)
  (let ((chart (gnc:make-html-chart))
    ...
    (gnc:html-chart-set-title! chart "Bar Chart Title")
    (gnc:html-chart-set-subtitle! chart "Bar Chart SubTitle")
    (gnc:html-chart-append-row! chart '(25 45 30))
    (gnc:html-chart-append-row! chart '(75 55 70))
    (gnc:html-chart-set-width! chart 320)
    (gnc:html-chart-set-height! chart 240)
    (gnc:html-chart-set-row-labels! chart '("date1" "date2"))
    (gnc:html-chart-set-col-labels! chart '("dataset1" "dataset2" "dataset3"))
    (gnc:html-chart-set-col-colors! chart (gnc:assign-colors 3))
    (gnc:html-chart-set-stacked?! chart stacked?)
    (gnc:html-chart-set-y-axis-label! chart "A Y Axis")
    chart))
...
(define (simple-scatter-chart)
  (let ((chart (gnc:make-html-chart))
    ...
    (gnc:html-chart-set-subtitle! chart "Scatter SubTitle")
    (gnc:html-chart-add-datapoint! chart '(25 75))
    (gnc:html-chart-add-datapoint! chart '(45 55))
    (gnc:html-chart-add-datapoint! chart '(70 30))
    (gnc:html-chart-set-width! chart 320)
    (gnc:html-chart-set-height! chart 240)
    (gnc:html-chart-set-markercolor! chart (car (gnc:assign-colors 1)))
    chart))
